package co.unicauca.solid.liskov.presentation;

import co.unicauca.solid.liskov.domain.Trip;
import co.unicauca.solid.liskov.domain.Truck;
import co.unicauca.solid.liskov.domain.SpecializedTruck;
