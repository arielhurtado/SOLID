...
public class Truck {
    ...
    /**
     * Almacena la distancia anterior recorrida por el vehiculo
     */
    protected double oldodometer;
    /**
    ...
    //invariant{old_odometer = new_Odometer}
    public void addTrip(Trip newTrip) {
        try{
        trips.add(newTrip);
        if(oldodometer != odometer) throw new Exception("Se incumple invariante");
        } catch (Exception e) {
            e.printStackTrace(); }
