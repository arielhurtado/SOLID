...
public class Factory {
    ...
    private Factory() {
        ...
        deliveryDictionary.put(CountryEnum.PERU, new PeruDelivery());
        deliveryDictionary.put(CountryEnum.CHILE, new ChileDelivery());
        deliveryDictionary.put(CountryEnum.GUATEMALA, new GuatemalaDelivery());
        deliveryDictionary.put(CountryEnum.CHINA, new ChinaDelivery());
        deliveryDictionary.put(CountryEnum.BOLIVIA, new BoliviaDelivery());
        deliveryDictionary.put(CountryEnum.BRASIL, new BrasilDelivery());
        deliveryDictionary.put(CountryEnum.EGIPTO, new EgiptoDelivery());
